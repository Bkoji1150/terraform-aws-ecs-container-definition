...
This module builds the infrastructure for **terraform-aws-ecs-container-definition** agen in the **REPORTING-BACKEND** cell.
...
```
## Usage Single task definition
```hcl

module "container_definition" {
  source = "git::git@github.com:Bkoji1150/terraform-aws-ecs-container-definition.git"
